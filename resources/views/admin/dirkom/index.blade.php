    ...
    <div class="modal fade" id="Add_dirkom" tabindex="-1" aria-labelledby="Add_dirkom" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="addDirkomForm" action="{{ route('admin.komisaris.add.do') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control @error('foto_dirkom') is-invalid @enderror"
                                id="foto_dirkom"name="foto_dirkom">
                            @error('foto_dirkom')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
...
<script>
    document.getElementById('addDirkomForm').addEventListener('submit', function(event) {
        event.preventDefault(); // Menghentikan submit form standar
