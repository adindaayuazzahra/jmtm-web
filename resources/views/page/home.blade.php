    ...
    <div id="content" class="text-white d-flex align-items-center">
        <div class="container">
            ...
            <p data-aos="slide-up">JMTM merupakan anak perusahaan <strong>PT Jasa Marga (Persero) Tbk</strong> <br>
                ...
                <strong>0,1%</strong> persen milik Induk Koperasi Karyawan Jasa Marga.</p>
        </div>
    </div>
</div>

<div class="container" id="kartu_kuning">
            ...
            <div class="col-md col-sm-12">
                <div class="card h-100 shadow justify-content-between">
                    <div class="col">
                        ...
                        <p class="mt-2">Kontrak manajemen pemeliharaans merupakan kegiatan perencanaan dan pelaksanaan pemeliharaan jalan tol.</p>
                    </div>
                    <div class="col-8">
                        <a href="{{route('layanan.kontrak')}}" class="btn btn-outline-dark btn-sm mt-3 stretched-link rounded-pill" role="button">Lihat Detail <i class="fa-solid fa-circle-chevron-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-md col-sm-12">
                <div class="card h-100 shadow justify-content-between">
                    <div class="col">
                        ...
                        <p class="mt-2">JMTM dalam bidang proyek konstruksi saat ini telah memperoleh kepercayaan untuk mengerjakan proyek skala besar dari berbagai pihak.</p>
                    </div>
                    <div class="col-8">
                        <a href="{{route('layanan.general')}}" class="btn btn-outline-dark btn-sm mt-3 stretched-link rounded-pill" role="button">Lihat Detail <i class="fa-solid fa-circle-chevron-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-md col-sm-12">
                <div class="card h-100 shadow justify-content-between">
                    <div class="col">
                        ...
                        <p class="mt-2">JMTM menyediakan pekerjaan sipil yang komprehensif untuk layanan survey pemeliharaan Jalan Tol dan Jembatan.</p>
                    </div>
                    <div class="col-8">
                        <a href="{{route('layanan.survey')}}" class="btn btn-outline-dark btn-sm mt-3 stretched-link rounded-pill" role="button">Lihat Detail <i class="fa-solid fa-circle-chevron-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-md col-sm-12">
                <div class="card h-100 shadow justify-content-between">
                    <div class="col">
                        ...
                        <p class="mt-2">JMTM memiliki layanan penyewaan alat berat untuk lingkup internal dan external. </p>
                    </div>
                    <div class="col-8">
                        <a href="{{route('layanan.sewa.he')}}" class="btn btn-outline-dark btn-sm mt-3 stretched-link rounded-pill" role="button">Lihat Detail <i class="fa-solid fa-circle-chevron-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-md col-sm-12">
                <div class="card h-100 shadow justify-content-between">
                    <div class="col">
                        ...
                        <p class="mt-2">JMTM Memproduksi berbagai macam aspal yang sudah memiliki kualitas yang sudah teruji.</p>
                    </div>
                    <div class="col-8">
                        <a href="{{route('layanan.produk')}}" class="btn btn-outline-dark btn-sm mt-3 stretched-link rounded-pill" role="button">Lihat Detail <i class="fa-solid fa-circle-chevron-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
...
<section id="home-berita">
    ...
    <div class="row text-center">
        <div>
            <a href="{{route('berita')}}" class="btn btn-outline-dark rounded-pill mt-4" role="button">Lihat Berita Lainnya <i class="fa-solid fa-arrow-right-long ms-1"></i></a>
        </div>
    </div>
</section>
@endsection
